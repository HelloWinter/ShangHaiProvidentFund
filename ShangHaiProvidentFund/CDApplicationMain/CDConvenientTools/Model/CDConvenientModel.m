...
- (void)setupArrdata{
    ...
    CDConvenientToolsItem *item6=[CDConvenientToolsItem itemWithImageName:@"convenient_tool7" title:@"年终奖计算"];
    CDConvenientToolsItem *item7=[CDConvenientToolsItem itemWithImageName:@"convenient_tool8" title:@"叫号信息"];
    CDConvenientToolsItem *item8=[CDConvenientToolsItem itemWithImageName:@"convenient_tool9" title:@"公益短信"];
